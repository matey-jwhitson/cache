      ...
      <div className="w-full max-w-md space-y-8 px-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8 shadow-2xl backdrop-blur-md">
          ...
          >
            <button
              type="submit"
              className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl bg-white px-4 py-3 text-sm font-medium text-neutral-900 transition-all hover:bg-neutral-100 active:scale-[0.98]"
            >
